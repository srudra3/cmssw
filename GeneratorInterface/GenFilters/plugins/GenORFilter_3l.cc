// -*- C++ -*-
//
// Package:    MyGenFilters/GenORFilter_3l
// Class:      GenORFilter_3l
//
/**\class GenORFilter_3l GenORFilter_3l.cc MyGenFilters/GenORFilter_3l/plugins/GenORFilter_3l.cc
...
//         Created:  Wed, 22 Apr 2026 21:52:14 GMT
//
//
...
class GenORFilter_3l : public edm::stream::EDFilter<> {
public:
  explicit GenORFilter_3l(const edm::ParameterSet&);
  ~GenORFilter_3l() override;
...
//
GenORFilter_3l::GenORFilter_3l(const edm::ParameterSet& iConfig)
...
GenORFilter_3l::~GenORFilter_3l() {
}


// ------------ method called on each new Event  ------------
bool GenORFilter_3l::filter(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
...
void GenORFilter_3l::beginStream(edm::StreamID) { }
void GenORFilter_3l::endStream() { }

void GenORFilter_3l::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  desc.add<edm::InputTag>("jets", edm::InputTag("tmpAk4GenJetsNoNu"));
    ...
    desc.add<unsigned int>("minLeptons", 3);
    desc.add<unsigned int>("minLeptonsHard", 3);
    descriptions.add("GenORFilter_3l", desc);
}
//define this as a plug-in
DEFINE_FWK_MODULE(GenORFilter_3l);
